...
void WindMillObj::Init()
{
	...
	AddComponet<DrawModel>()->Init("asset\\model\\windmill.obj");
	...
	m_Collision->SetScale(D3DXVECTOR3(3.0f, 5.0f, 3.0f));

	GameObject::Init();
}

void WindMillObj::Uninit()
{
...
void WindMillObj::Update()
{

	GameObject::Update();
}

void WindMillObj::Draw()
{
	// 入力レイアウト設定
