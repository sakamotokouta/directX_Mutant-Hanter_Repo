...
void GeneralStoreObj::Init()
{
	...
	AddComponet<DrawModel>()->Init("asset\\model\\generalstore01.obj");
...
void GeneralStoreObj::Update()
{

	GameObject::Update();
}

void GeneralStoreObj::Draw()
{
	// 入力レイアウト設定
