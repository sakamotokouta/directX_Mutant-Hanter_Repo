...
private:
	...
	static ID3D11Buffer* m_EnemyBuffer;
...
public:
	...
	static void SetEnemy(ENEMYPARAM Enemy);
	...
	static void SetCameraPosition(D3DXVECTOR3 pos) {
		D3DXVECTOR4 cpos(pos.x, pos.y, pos.z, 1.0f);
		m_DeviceContext->UpdateSubresource(m_CameraBuffer, 0, NULL, &cpos, 0, 0);
	}

	static void SetRasterizerEnable(bool flg);
