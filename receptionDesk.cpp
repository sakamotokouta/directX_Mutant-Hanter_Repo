...
void RECEPTIONDESK::Init()
{
	...
	m_Model->Load("asset\\model\\Peasant Girl.fbx");
	...
	m_ReceptionState = RECEPTION_STATE_IDLE;
...
void RECEPTIONDESK::Update()
{

	GameObject::Update();
}

void RECEPTIONDESK::Draw()
{
	Scene* scene = Manager::GetScene();
