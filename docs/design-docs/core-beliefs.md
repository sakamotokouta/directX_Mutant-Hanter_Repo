...
8. **AI is a controlled collaborator.** Claude Code may propose and implement changes, but project instructions, path rules, hooks, diffs, validation, and human decisions remain visible.
