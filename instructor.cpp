...
void Instructor::Init()
{
	...
	m_Model->Load("asset\\model\\Uriel A Plotexia.fbx");
	m_Model->LoadAnimation("asset\\model\\Breathing Idle (1).fbx", "Idle01");

	m_AnimationName = "Idle01";
	m_NextAnimationName = "Idle01";

	m_Scale = D3DXVECTOR3(0.011f, 0.011f, 0.011f);
