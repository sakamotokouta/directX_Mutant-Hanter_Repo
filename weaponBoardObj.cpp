...
void WeaponBordObj::Init()
{
	...
	AddComponet<DrawModel>()->Init("asset\\model\\qwaponBoard.obj");
...
void WeaponBordObj::Update()
{

	GameObject::Update();
}

void WeaponBordObj::Draw()
{
	// 入力レイアウト設定
